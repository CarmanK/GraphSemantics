...
# possibly create a folder for all of the binaries that must be run and only leave the shell scripts outside, the corpus_indexer was already separatedto the extra directory

MODEL=${MODEL:- "models/Trained_Model"}
OUTPUT_LOCATION=${OUTPUT_LOCATION:-../../output_data/tmp}
TEXT_TO_SEG=${TEXT_TO_SEG:-../../output_data/tmp/titles.txt}
HIGHLIGHT_SINGLE=${HIGHLIGHT_SINGLE:- 10.0}
HIGHLIGHT_MULTI=${HIGHLIGHT_MULTI:- .5}
